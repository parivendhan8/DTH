...
public class EmailVerify extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        session = new SessionManager((FragmentActivity) getApplicationContext());
            ...
            public void onResponse(Object response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        db.addUser(json_user.getString(KEY_UID), json_user.getString(KEY_NAME), json_user.getString(KEY_CREATED_AT));
